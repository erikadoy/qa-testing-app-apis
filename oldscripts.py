...
# TEAM_NAMES = [
#     "Platform Engineering", "Cloud Infrastructure", "DevOps Guild",
#     "API Services Team", "Observability Squad", "Data Engineering",
#     "Site Reliability Group", "Frontend Systems", "Backend Services",
#     "AI/ML Research Unit", "Security Engineering", "Automation Crew",
#     "Release Management", "Integration Services", "Edge Compute Team",
#     "Developer Experience", "Mobile Engineering", "Core Services",
#     "Identity & Access", "Payments Platform", "Search & Indexing",
#     "Analytics Pipeline", "Content Delivery", "Incident Response Team"
# ]

# TEMPLATE_TYPES = [
#     "microservice-basic", "microservice-advanced", "monolith-web",
#     "serverless-function", "data-pipeline", "ml-training",
#     "frontend-react", "frontend-vue", "api-gateway", "event-driven"
# ]
...
# def random_version():
#     return f"{random.randint(1,5)}.{random.randint(0,20)}.{random.randint(0,50)}"

# def random_date():
#     start_date = datetime.now() - timedelta(days=730)
#     return (start_date + timedelta(days=random.randint(0,730))).strftime("%Y-%m-%d")
...
#         templates_used = random.sample(TEMPLATE_TYPES, num_templates)
...
#             "template_versions": [random_version() for _ in templates_used],
#             "last_updated": random_date(),
#             "status": random.choice(["active", "maintenance", "deprecated", "archived"]),
#             "repository_url": f"https://github.com/company/{full_name}",
...
# def create_project(new: ProjectCreate):
#     new_id = f"PROJ-{1000 + len(MOCK_DATABASE)}"
#     project = {
#         "project_id": new_id,
#         "project_name": new.project_name,
#         "team_name": new.team_name,
#         "templates": new.templates,
#         "no_temps_used": len(new.templates),
#         "template_versions": [random_version() for _ in new.templates],
#         "status": "active",
#         "created_date": datetime.now().strftime("%Y-%m-%d"),
#         "last_updated": datetime.now().strftime("%Y-%m-%d"),
#         "repository_url": f"https://github.com/company/{new.project_name}"
#     }
#     MOCK_DATABASE.append(project)
...
#             if update.team_name is not None:
#                 project["team_name"] = update.team_name
...
#                 project["no_temps_used"] = len(update.templates)
#                 project["template_versions"] = [random_version() for _ in update.templates]
...
#         if project["project_id"] == project_id:
#             deleted = MOCK_DATABASE.pop(i)
#             return {"message": "Project deleted", "project": deleted}
...
#         raise HTTPException(status_code=404, detail="No projects found for that team")
#     return {"team_name": team_name, "project_count": len(team_projects), "projects": team_projects}
...
#         raise HTTPException(status_code=404, detail="No projects found using that template")
#     return {"template_type": template_type, "project_count": len(template_projects), "projects": template_projects}
